...
| Quality chests and printers | Adjust `Allow Quality Chests` and LevelUpChoices' item-source removal setting | By default, quality chest and printer sources are removed with other item sources. |
